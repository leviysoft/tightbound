...
import tightbound.math.*
import tightbound.math.aliases.*
import tightbound.math.syntax.*
import tightbound.core.LemmaConversions.{`Matrix[H, W1 <= W2, A]`, `W - 1 > 0 =:= W > 1`}
import tightbound.core.determinant.{DeterminantAlgorithm, LaplaceExpansion}
import tightbound.core.echelon.GaussianElimination
import tightbound.core.projection.ProjectionMatrix
import tightbound.core.inverse.{DeterminantGaussianElimination, InverseAlgorithm}
import tightbound.lemmas.given
