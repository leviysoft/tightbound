package tightbound.matrix

import tightbound.math.*
import tightbound.math.aliases.*
import tightbound.math.syntax.*
import tightbound.matrix.core.LemmaConversions.{`Matrix[H, W1 <= W2, A]`, `W - 1 > 0 =:= W > 1`}
import tightbound.matrix.core.determinant.{DeterminantAlgorithm, LaplaceExpansion}
import tightbound.matrix.core.echelon.GaussianElimination
import tightbound.matrix.core.projection.ProjectionMatrix
import tightbound.matrix.core.inverse.{DeterminantGaussianElimination, InverseAlgorithm}
